...
import { createProduct, getSupplierProducts } from "../../controllers/product/product.js";
...
Adminrouter.get("/get-supplier-products" ,authenticateUser ,authorizeRoles("supplier"), getSupplierProducts)
...
Adminrouter.put("/convert-status",authenticateUser,authorizeRoles("superadmin" , "supplier") ,  convertStatus)